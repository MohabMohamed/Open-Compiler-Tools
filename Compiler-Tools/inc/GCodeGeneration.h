...
namespace CT
{
	namespace CodeGen
	{
		...
		protected:
			...
			std::string generateParserHeader(const std::string& parser_name, const std::vector<CT::Parser::GParseNodePtr>& parse_rules);
			std::string generateParserCPP(const std::string& parser_name, const std::string& start_rule, const std::vector<CT::Parser::GParseNodePtr>& parse_rules);
			...
			std::tuple<std::string, std::string> generateParser(const std::string& parser_name, const std::string& start_rule, const std::vector<CT::Parser::GParseNodePtr>& parse_rules);
		public:
